...
`;
let my_profile_2 = `
    <h2 class="midp-font">Soy Kevin Fonseca</h2>
    <div class="sm-text">
        <p>
            Ingeniero de software con una sólida pasión por la programación y
            especialización en ciberseguridad, cuento con 7 años de trayectoria
            profesional, dedicando los últimos 3.5 años al fortalecimiento de la
            seguridad cibernética y al manejo de big data.
        </p>
        <p>
            Definicion de estandares y las mejores soluciones tecnologicas para proteger
            la seguridad de la compañia ante agentes externos.
            *Deteccion de instruccione, analisis y revision de malware.
            *gestion de seguridad y claves criptograficas de los sistemas de seguridad de la
            compañia
        </p>
    </div>
`;
let my_profile_3 = `
    <h2 class="midp-font">Soy Edwin Andres Tangarife Salamando</h2>
    <div class="sm-text">
        <p>
            Desarrollador frontend especializado en VTEX IO y el desarrollo de componentes personalizados utilizando React, 
            JavaScript y TypeScript. Competente en HTML, CSS, Tailwind CSS, Material-UI, Bootstrap, Next.js y experiencia con 
            GraphQL, API REST, Docker, WordPress (Elementor, Divi), Git (GitHub, GitLab) y GitScrum.
        </p>
        <p>
            Experto en la creación de interfaces receptivas y de alto rendimiento y en la realización de pruebas unitarias con Jest.
            Comprometidos con la calidad del código, las mejores prácticas y la mejora continua.
        </p>
    </div>
`;
let my_profile_4 = `
...
`;
let my_profile_5 = `
    <h2 class="midp-font">Soy Jhon Jairo Caicedo Victoria</h2>
    <div class="sm-text">
        <p>
            Ingeniero de Software Junior recién egresado con 1 año de experiencia práctica (incluyendo prácticas profesionales y proyectos personales), enfocado en el desarrollo móvil nativo y multiplataforma (Kotlin/Swift, Flutter)
        </p>
        <p>
            Rápido aprendizaje y gran interés en aplicar buenas prácticas de programación, pruebas unitarias y TDD (Desarrollo Guiado por Pruebas). Proactivo en la resolución de problemas y altamente motivado a contribuir en un entorno de equipo.
        </p>
    </div>
`;
let myskillstitle = `
...
let myskillstitle2 = `
    ...
    <div class="prof-profile sm-text">
        <p>
            Ingeniero de Software Senior con 8 años de experiencia, especializado en el diseño, desarrollo e implementación de APIs robustas y sistemas distribuidos de alta disponibilidad. Experto en Python (Django/Flask) y Java (Spring Boot), con un profundo conocimiento de bases de datos relacionales y NoSQL (PostgreSQL, MongoDB).
        </p>
    </div>
    <div class="skill">
        <div class="logo-lang">
...
let myskillstitle3 = `
    ...
    <div class="prof-profile sm-text">
        <p>
            Python (Django, Flask), Java (Spring Boot), SQL, Microservicios, Sistemas Distribuidos, Diseño de APIs RESTful/GraphQL, Patrones de diseño de software.
        </p>
    </div>
    <div class="skill">
        <div class="logo-lang">
...
let myskillstitle4 = `
    ...
    <div class="prof-profile sm-text">
        <p>
            JavaScript/TypeScript, React (Hooks, Redux), Vue.js, HTML5, CSS3 (Sass/Less), Node.js (Express), Bases de datos relacionales y NoSQL.
        </p>
    </div>
    <div class="skill">
        <div class="logo-lang">
...
let myskillstitle5 = `
    ...
    <div class="prof-profile sm-text">
        <p>
            Kotlin (Android), Swift (iOS), Flutter o React Native (Conocimiento básico/intermedio), Pruebas Unitarias, TDD (Desarrollo Guiado por Pruebas), Revisión de código (Code Review), Refactorización.
        </p>
    </div>
    <div class="skill">
        <div class="logo-lang">
...
let intro_projects =  `
    <div class="prof-profile sm-text">
        <p>
            En nuestra trayectoria, hémos construido una variedad de proyectos,
            los cuales han implicado la aplicación y el aprendizaje de distintas habilidades en torno
            al desarrollo de software. Estos proyectos nos han permitido comprender y perfeccionar los
...
let contacters = `
    <div class="itext">
        ...
        <span class="mid-font">Contáctanos, podemos brindarte asesoría personalizada.</span>
...
let my_social = `
    ...
    <div class="downs">
        ...
        <div class="footer">
            <span class="sm-text">Diseñado y construido por <b>Estudiantes de la CORP. Universitaria Iberoamericana</b></span>
            <span class="logotp"></span>
            <span class="sm-text">©︎ Consultoría de software ${year}</span>
            <div class="technologies">
